...
export default function Tea_Map(){
    ...
    return (
        <div className={styles.Tea_Map}>
            ...
            <h1  id="Tea_Map" className={styles.title} > Tea Map </h1>
            <div className={styles.wraper}>
                ...
                <div>
                    ...
                    <p>From the misty Himalayan slopes to Londons tea culture, every sip of a <strong>Tea Latte Co.</strong> drink tells a story of craftsmanship and tradition. We take pride in bringing the finest Darjeeling tea to our customers, transforming it into velvety, aromatic tea lattes.</p>
                </div>
